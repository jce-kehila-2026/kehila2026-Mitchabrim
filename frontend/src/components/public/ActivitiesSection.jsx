        ...
        <div className="act2-grid">
          ...
          <div className="act2-heading">
            <div className="act2-title-row">
              <h2 className="act2-title">העשייה שלנו</h2>
              <svg
                className="act2-heart"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.8"
            ...
            <p className="act2-sub">ארבעה תחומי פעילות מרכזיים שהופכים את הקהילה לחמה יותר.</p>
          ...
          <div className="act2-stage" aria-label="תחומי פעילות">
            ...
            <div className="act2-bubble act2-bubble-top">
              <div className="act2-bubble-inner">
                ...
                <h3 className="act2-bubble-title">פרלמנטים</h3>
                <p className="act2-bubble-desc">
                  שיח בין דורי, השפעה
                  <br />
                  וקבלת החלטות יחד.
                </p>
            ...
            <div className="act2-bubble act2-bubble-bl">
              <div className="act2-bubble-inner">
                ...
                <h3 className="act2-bubble-title">קשר רציף</h3>
                <p className="act2-bubble-desc">
                  ליווי מתמשך לאורך זמן
                  <br />
                  ומענה לצרכים משתנים.
                </p>
              </div>
            ...
            <div className="act2-bubble act2-bubble-br">
              <div className="act2-bubble-inner">
                ...
                <h3 className="act2-bubble-title">פרויקטי חגים</h3>
                <p className="act2-bubble-desc">
                  יוצרים שמחה, חוויה
                  <br />
                  וקירוב לבבות.
            ...
            <div className="act2-center">
              ...
              <div className="act2-center-inner">
                ...
                <h3 className="act2-center-title">התנדבות אישית</h3>
                ...
                <p className="act2-center-desc">
                  חיבור בין מתנדבים לאזרחים
                  <br />
