...
const workdir = resolve(tmpdir(), "mitchabrim-sec07-emulator");
const configHome = resolve(tmpdir(), "mitchabrim-sec07-firebase-config");
...
const result = spawnSync(
  ...
  [
    ...
    "--only",
    "auth,firestore",
    `node ${JSON.stringify(resolve(root, "tests", "sec-07.rules.test.mjs"))}`,
  ],
  {
    cwd: workdir,
    stdio: "inherit",
